...
def main():
    ...
    leapse_logo = Image.open(r"C:\Users\bicap\Documents\UFU\pos_graduacao\scripts\abril_24\streamlit_app\images\leapse.png")
    ...
    with st.popover("Supported by 👨‍🏫"):
        ...
        capes_logo = Image.open(r"C:\Users\bicap\Documents\UFU\pos_graduacao\scripts\abril_24\streamlit_app\images\capes.png")
        pop_col1.image(capes_logo, caption = "CAPES - Coordination for the Improvement of Higher Education Personnel", width=200)
        ufu_logo = Image.open(r"C:\Users\bicap\Documents\UFU\pos_graduacao\scripts\abril_24\streamlit_app\images\ufu.png")
        pop_col2.image(ufu_logo, caption = "UFU - Federal University of Uberlândia", width=200)
        ppgeelt_logo = Image.open(r"C:\Users\bicap\Documents\UFU\pos_graduacao\scripts\abril_24\streamlit_app\images\ppgeelt.png")
